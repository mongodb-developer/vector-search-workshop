...
Enter your OpenAI API key in the `OPENAI_API_KEY` parameter. This is the key you created in the [Create your OpenAI Account](/docs/2-openai/2-create-account) section.
